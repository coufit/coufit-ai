...
# 숫자 코드 생성
df['category_code'] = df['category_name'].map(category_code_dict).fillna('9999')

# 기타 필드 생성
df['open_time'] = [random.choice(['08:00:00', '09:00:00', '10:00:00', '11:00:00', '12:00:00']) for _ in range(len(df))]
df['close_time'] = [random.choice(['20:00:00', '21:00:00', '22:00:00', '23:00:00', '24:00:00']) for _ in range(len(df))]
